...
export default function Lobby({ setUser, setRoomCode }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-200 to-pink-200">
      ...
      />
      <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mb-2" onClick={createRoom}>
        Create Room
      </button>
      <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded" onClick={joinRoom}>
        Join Room
      </button>
